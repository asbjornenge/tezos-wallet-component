...
function truncateAddress(addr) {
  return "".concat(addr.substring(0, 7), "..").concat(addr.substring(addr.length - 4, addr.length));
}
...
var TezosWalletMenuDisconnect = function TezosWalletMenuDisconnect(props) {
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "icon"
  }, /*#__PURE__*/React.createElement(DisconnectIcon, null)));
};
...
var TezosWallet = function TezosWallet(props) {
  var _useState = (0, _react.useState)(null),
      ...
      tezIDProfile = _useState2[0],
      setTezIDProfile = _useState2[1];

  (0, _react.useEffect)(function () {
    if (props.tezidProfile && props.address) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return fetch("https://tezid.net/api/".concat(props.network, "/avatar/").concat(props.address)).then(function (r) {
                  return r.json();
                });

              case 3:
                profile = _context.sent;
                setTezIDProfile(profile);
                _context.next = 10;
                break;
              ...
              case 7:
                ...
                console.error("Unable to get TezID Profile for ".concat(props.address));
  ...
  }, [props.address, props.tezidProfile, props.network]);
  ...
  if (!props.address) {
    var networkMenuItems = (props.networks || []).map(function (n) {
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "icon"
      }, n.testnet && /*#__PURE__*/React.createElement(TestnetIcon, null), /*#__PURE__*/React.createElement(NetworkIcon, null)));
    });
    ...
    }, /*#__PURE__*/React.createElement(WalletIcon, null)), /*#__PURE__*/React.createElement("div", {
  ...
  if (props.tezidProfile && tezIDProfile && tezIDProfile !== null && tezIDProfile !== void 0 && tezIDProfile.avatar) {
    idimgStyle = {
      backgroundImage: "url(".concat(getIpfsLink(tezIDProfile.avatar), ")")
    };
  }
  ...
  }, !props.hideBalance && /*#__PURE__*/React.createElement("div", {
    className: "balance"
  }, formatBalance(props.balance || 0), " \uA729"), !props.hideSpacer && /*#__PURE__*/React.createElement("div", {
    className: "spacer"
  }), !props.hideIdImage && (idimg != null || idimgStyle != null) && /*#__PURE__*/React.createElement("div", {
    className: "identityImage",
    style: idimgStyle
  }, idimg != null && /*#__PURE__*/React.createElement("img", {
    alt: "identity",
    src: idimg.src
  })), !props.hideAddress && /*#__PURE__*/React.createElement("div", {
    className: "address"
  }, truncateAddress(props.address)), /*#__PURE__*/React.createElement("div", {
    className: "TezosWalletMenu",
    style: {
      display: props.showMenu ? 'flex' : 'none'
    },
